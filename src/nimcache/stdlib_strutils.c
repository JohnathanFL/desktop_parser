...
/* Command for C compiler:
   gcc -c  -w  -I'/home/oakenbow/.choosenim/toolchains/nim-#devel/lib' -o /home/oakenbow/Dev/Projects/desktop-parser-nim/src/nimcache/stdlib_strutils.o /home/oakenbow/Dev/Projects/desktop-parser-nim/src/nimcache/stdlib_strutils.c */
...
STRING_LITERAL(TM_JGc9b9bh2D3nTdUR7TGyq8aA_23, "0123456789ABCDEF", 16);
...
N_LIB_PRIVATE N_NOINLINE(void, invalidFormatString_61EJWW6vRISEo9a8gt0tusw)(void) {
	...
	(*e).Sup.Sup.m_type = (&NTI_Gi06FkNeykJn7mrqRZYrkA_);
	T1_ = (NimStringDesc*)0;
	T1_ = (*e).Sup.message; (*e).Sup.message = copyStringRC1(((NimStringDesc*) &TM_JGc9b9bh2D3nTdUR7TGyq8aA_22));
	...
	result = mnewString(((NI) (len)));
	{
		...
		res = colontmp_;
		{
			while (1) {
				...
				j = res;
				result->data[j] = ((NimStringDesc*) &TM_JGc9b9bh2D3nTdUR7TGyq8aA_23)->data[(NI64)(n & IL64(15))];
